...
public class UserApi {
    ...
    public static String createUser(String email, String password, String name) {
        ...
        // Отправляю запрос (POST) на регистрацию пользователя
        ...
        // Получаю токен для дальнейших действий с пользователем
    ...
    public static void loginUser(String email, String password) {
        // Получаю токен и сохраняю в поле token
    ...
    public static void deleteUser(@Param(mode = HIDDEN) String token) {
        ...
        // Отправляю запрос (DELETE) на удаление пользователя
        given().log().all()
